            ...
            child: Column(
              children: <Widget>[
                ...
                firebaseUIButton(context, "Ingresar", () {
                  String email = _emailTextController.text.trim(); // Eliminar espacios en blanco alrededor del correo electrónico
                  String password = _passwordTextController.text;
                  if (isValidEmail(email)) { // Validar el correo electrónico
                    ...
                    // Mostrar un mensaje de error al usuario indicando que el formato del correo electrónico es incorrecto
                  }
                }),
                signUpOption()
              ],
